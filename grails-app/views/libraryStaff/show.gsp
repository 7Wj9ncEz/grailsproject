...
<html>
    ...
    <body>
        <a href="#show-libraryStaff" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
        ...
        <div id="show-libraryStaff" class="content scaffold-show" role="main">
